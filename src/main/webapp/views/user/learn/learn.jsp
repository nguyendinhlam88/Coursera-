...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="views/user/learn/assets/css/base.css" />
    <link rel="shortcut icon" href="#">
    <link rel="stylesheet" href="views/user/learn/assets/css/learn.css" />
    ...
    <div class="wrapper">
        ...
        <div class="header__navbar">
          <nav class="header__navbar-list">
            ...
            <div class="navbar__item-category">
              <button class="item__category-btn"><i class="fas fa-bars"></i></button>
            </div>
            <!-- logo -->
          ...
          <nav class="header__navbar-list">
              <button class="navbar__item-notify" title="notify">
      ...
      <div class="breadcrumb">
        <li class="breadcrumb-list">
          ...
          <ul class="breadcrumb-section" title="section title">Introduction to Marketing</ul>
          <ul class="breadcrumb-separator"><i class="fas fa-chevron-right"></i></ul>
          <ul class="breadcrumb-video" title="video name">Introduction &amp; Install</ul>
        </li>
        <li class="breadcrumb-list">
          ...
          <div class="container-mid">
            <div class="content__main">
              ...
              <div class="content__main-video">
                <iframe class="main___video" src="https://www.youtube.com/embed/4_ddOSTmR4M" allowfullscreen></iframe>
              </div>
              ...
              <div class="content__main-info">
                ...
                <div class="main__info-actions">
                  <div class="info__actions-list">
                    ...
                    <div class="main__info-download">
                      <button class="main__info-btnDownload">
                        <span>Download</span>
                        <i class="fas fa-angle-down"></i>
                      </button>
                      <ul class="main__info-materials">
                      </ul>
                    </div>
                  </div>
                  <div class="info__actions-list">
                    ...
                    <button class="info__actions-item-Seen">
                      <i class="far fa-square active"></i>
        ...
        <div class="grid__column-22">
          ...
          <div class="sidebar__notebook">
            ...
            <div class="sidebar__notebook-info">
              ...
              <div class="sidebar__notebook-container">
      ...
      <div class="item__category-modal">
        <div class="container">
          <div class="category__modal-header">
            <button class="item__category-btn1"><i class="fas fa-bars"></i></button>
            <!-- logo -->
            <a href="/"><img src="views/user/learn/assets/img/logo.png" alt="Web Logo" class="navbar__item-logo"></a>
          </div>
          <!-- search -->
      ...
      <div class="thread__modal">
        <div class="container">
          ...
          <div class="thread__modal-content">
            ...
            <!-- Course Complete Percent -->
      <div class="course__percent-modal">
        <i class="far fa-lightbulb"></i>
        <div class="course__percent-modal-info">
          <h3 class="course__percent-modal-header">Thống kê khoá học</h3>
          <div class="course__percent-modal-content">Cho đến nay bạn đã học được <b class="b1">1 giờ</b> của khoá học này. Tương ứng với <b class="b2">5/7</b> phần của khoá hoc. Hãy tiếp tục nhé!</div>
          <div class="course__percent-modal-action">
            <span>Thông báo tốt không?</span>
            <button class="course__percent-modal-yes">Có</button>
            <button class="course__percent-modal-no">Không</button>
          </div>
        </div>
        <button class="course__percent-modal-close" title="Close"><i class="fas fa-times"></i></button>
      </div>
    <script src="views/user/learn/assets/js/learn.js"></script>
  </body>
</html>
